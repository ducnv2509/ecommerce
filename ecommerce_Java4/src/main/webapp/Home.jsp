...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="${pageContext.servletContext.contextPath}/include/assets/img/favicon.ico">
  ...
  <div class="carousel-inner">
      ...
      <div class="container">
        <div class="row p-5">
          <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
            <img class="img-fluid" src="${pageContext.servletContext.contextPath}/include/assets/img/banner_img_01.jpg" alt="">
          </div>
    ...
    <div class="carousel-item">
      <div class="container">
        <div class="row p-5">
          <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
            <img class="img-fluid" src="${pageContext.servletContext.contextPath}/include/assets/img/banner_img_02.jpg" alt="">
          </div>
          <div class="col-lg-6 mb-0 d-flex align-items-center">
    ...
    <div class="carousel-item">
      <div class="container">
        <div class="row p-5">
          <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
            <img class="img-fluid" src="${pageContext.servletContext.contextPath}/include/assets/img/banner_img_03.jpg" alt="">
          </div>
          <div class="col-lg-6 mb-0 d-flex align-items-center">
            <div class="text-align-left">
...
<section class="container py-5">
  ...
  <div class="row">
   <c:forEach items="${products}" var="p" end="2">
     <div class="col-12 col-md-4 p-5 mt-3">
       <a href="#"><img src="${p.imageProduct}" class="rounded-circle img-fluid border"></a>
       <h5 class="text-center mt-3 mb-3">${p.nameProduct}</h5>
        ...
        <div class="col-12 col-md-4 mb-4">
          <div class="card h-100">
            <a href="shop-single.html">
              <img src="${p.imageProduct}" class="card-img-top" alt="...">
            </a>
            <div class="card-body">
              <ul class="list-unstyled d-flex justify-content-between">
                ...
                <li class="text-muted text-right">${p.price} $</li>
              </ul>
              <a href="shop-single.html" class="h2 text-decoration-none text-dark">${p.nameProduct}</a>
              <p class="card-text">
