    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <form action="ForgotPassword" method="post" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
                ...
                <div class="wrap-input100 validate-input" data-validate="Please enter code">
                    <input class="input100" type="text" name="code" placeholder="code">
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input" data-validate="Please enter code">
                    <input class="input100" type="text" name="password" placeholder="password new">
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input" data-validate="Please enter code">
                    <input class="input100" type="text" name="re_password" placeholder="re_password">
                    <span class="focus-input100"></span>
                </div>
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn"
                            formaction="ForgotPassword/reset"
                    >
                        Reset
                    </button>
                </div>
