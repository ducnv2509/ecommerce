...
<section class="bg-success py-5">
    <div class="container">
        <div class="row align-items-center py-5">
            ...
            <div class="col-md-4">
                <img src="${pageContext.servletContext.contextPath}/include/assets/img/about-hero.svg" alt="About Hero">
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="${pageContext.servletContext.contextPath}/include/assets/img/brand_01.png"
                                                             alt="Brand Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="${pageContext.servletContext.contextPath}/include/assets/img/brand_02.png"
                                                             alt="Brand Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="${pageContext.servletContext.contextPath}/include/assets/img/brand_03.png"
                                                             alt="Brand Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="${pageContext.servletContext.contextPath}/include/assets/img/brand_04.png"
                                                             alt="Brand Logo"></a>
                                        </div>
                                    </div>
                                </div>
